...
import edu.bootcamp.authSys.dto.request.AuthRequest;
import edu.bootcamp.authSys.dto.request.ResetPasswordRequest;
import edu.bootcamp.authSys.dto.response.AuthResponse;
import edu.bootcamp.authSys.service.ProfileService;
import edu.bootcamp.authSys.service.impl.AppUserDetailsService;
import edu.bootcamp.authSys.util.JwtUtil;
...
public class AuthController {
    ...
    public void resetPassword(@Valid @RequestBody ResetPasswordRequest passwordRequest) {
        try {
            profileService.resetPassword(passwordRequest.getEmail(), passwordRequest.getOtp(), passwordRequest.getNewPassword());
        } catch (Exception e) {
            throw new ResponseStatusException(HttpStatus.INTERNAL_SERVER_ERROR, e.getMessage());
        }
    }
    ...
    @PostMapping("/logout")
    public ResponseEntity<?> logiut(HttpServletResponse response) {
